...
class AppTheme {
  ...
  static final _weekViewTheme = WeekViewTheme.light().copyWith(
      // hourLine: Colors.red, // Need to be change
      // quarterHourLine: Colors.green,[
      // halfHourLine: Colors.yellow,
      // weekDayText: Colors.white,
      // weekDayTile: Colors.red,
      // liveIndicator: Colors.yellow,
      // pageBackground: Colors.red,
      );
