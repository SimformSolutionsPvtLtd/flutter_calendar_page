...
class WeekViewState<T extends Object?> extends State<WeekView<T>> {
      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: TextStyle(
              color: context.weekViewColors.weekDayText,
            ),
          ),
          Text(
  ...
  Widget _defaultTimeLineBuilder(DateTime date) => DefaultTimeLineMark(
        ...
        markingStyle: TextStyle(
          color: context.weekViewColors.timelineText,
          fontSize: 15.0,
        ),
      );
      ...
      headerStyle: widget.headerStyle ??
          HeaderStyle(
            decoration: BoxDecoration(
              color: context.weekViewColors.headerBackground,
            ),
            leftIconConfig: IconDataConfig(
              color: context.weekViewColors.headerIcon,
            ),
            rightIconConfig: IconDataConfig(
              color: context.weekViewColors.headerIcon,
            ),
            headerTextStyle: TextStyle(
              color: context.weekViewColors.headerText,
