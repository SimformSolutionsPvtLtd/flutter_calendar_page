...
class DarkAppColors {
  ...
  static const Color primaryContainer = Color(0xff723338);
  static const Color onPrimaryContainer = Color(0xffffdada);
  static const Color onSecondaryContainer = Color(0xffffdada);
  static const Color surfaceContainerHigh = Color(0xff322828);
  static const Color secondaryContainer = Color(0xff5d3f40);
